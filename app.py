...
def home_page():
    ...
    with st.expander("Monitoring Capabilities"):
        ...
        - *Flight dynamics* (roll, pitch, yaw) 🎚️📐🧭  
        - *Environmental data* (temperature, altitude) 🌡️🗻  
    ...
    while True:
        try:
            ...
            with container.container():
                ...
                col2.metric("🌡️ Temperature", f"{drone_data['Temperature']}°C")
                ...
                col4.metric("🎚️ Roll", f"{drone_data['Roll']}°")
